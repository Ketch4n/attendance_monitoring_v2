...
import 'package:attendance_monitoring/pages/estab/dashboard/dashboard.dart';
...
class EstabHome extends StatefulWidget {
  const EstabHome({super.key});

  @override
  _EstabHome createState() => _EstabHome();
}

class _EstabHome extends State {
